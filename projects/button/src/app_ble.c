...
uint8_t ad_data[20] = {
    ...
    5, AD_TYPE_COMPLETE_LOCAL_NAME, 'W', 'B', '5', '5',  /* Complete name */
    5, AD_TYPE_16_BIT_SERV_UUID_CMPLT_LIST, 0x00, 0x10, 0x00, 0x20,
...
UTIL_SEQ_RegTask( 1<< CFG_NOTIFY_HEARTRATE_EVT_ID, UTIL_SEQ_RFU, notify );
UTIL_SEQ_RegTask( 1<< CFG_NOTIFY_BUTT_ID, UTIL_SEQ_RFU, butt_notify );
